...
<section class="bg-footer border-t rounded-t border-white">
 ...
 -->
    ...
    <div class="grid grid-cols-3 grid-rows-2 md:grid-rows-1 gap-4 pb-2 mt-4">
        <!-- Newsletter Form -->
        <div class="col-span-3 md:col-span-1 row-start-1 md:row-start-1 mx-auto">
            <form method="POST" action="{{ route('newsletters.subscribe') }}" class="max-w-fit px-3 rounded-lg">
                @csrf
                <div class="space-y-4 items-center space-x-2">
                    <div class="form-group w-72">
                        <h2 class="mb-2 text-white font-normal"><strong> Inscrivez-vous à notre Newsletter</strong></h2>
