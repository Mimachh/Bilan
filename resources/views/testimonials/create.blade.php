...
<header class="bg-white shadow">
    <div class="text-center py-8 bg-black-perso">
       <h1 class="font-bold text-center text-3xl text-gradient">TEMOIGNER</h1> 
    </div>
</header>

<section class="min-h-screen md:relative bg-white">
<div class="grid text-black md:grid-cols-3 gap-4 my-4 md:mt-6">
  <div class="md:col-span-2 px-4 md:pr-8 py-4">
    <div class="space-y-2">

        <!-- Formulaire -->
        <div class="pt-6 rounded-lg">
            <div class="pb-12 max-w-[700px] mx-auto px-3 lg:px-6">
                <div class="flex justify-end space-x-1 pt-4 bg-red-500 mb-4 md:mb-12">
                    Pub 
                </div>
                ...
                <h2 class="text-2xl font-bold text-center mt-4 mb-6">Envoyer un témoignage</h2>
                <small>Les champs marqué de <span class="text-red-600 text-lg">*</span> sont obligatoires</small>
                <form  method='POST' action="{{ route('testimonials.store') }}">
                    ...
                    <div class="form-group form-check text-center mb-6">
                        <input name="statut" type="checkbox"
                            value="1" class="form-check-input appearance-none h-4 w-4 border border-gray-300 rounded-sm bg-white checked:bg-blue-600 checked:border-red-600 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center bg-contain mr-2 cursor-pointer"
                            id="statut">
                        <label class="form-check-label inline-block" for="statut">
    ...
    <!-- Caroussel -->
    <!-- CENTRER -->
    <div class="space-y-2 grid grid-cols-1 gap-4 content-center md:pr-4">
