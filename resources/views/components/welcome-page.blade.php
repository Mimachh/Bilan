<section id="" class="bg-image bg-black-perso">
    <div class="space-y-8 min-h-screen place-content-center grid justify-items-center font-bold">
        <div class="text-white text-center">
            <h3 class="mb-8 text-2xl font-bold">Le bilan déplorable en temps réel <br> de son quinquenat.</h3>
            <a class="bg-blue-perso px-8 text-lg py-4 rounded" href="#categories">Aller voir</a>
        </div>
