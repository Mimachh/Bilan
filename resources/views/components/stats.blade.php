<section class="h-screen pt-4 bg-black-perso">
        ...
        <div class="space-y-4 col-span-3 md:col-span-2 bg-gray-200 px-4 py-4 rounded">
            ...
            <div>
                ...
                <div>
                    <a id="whatsapp" href="whatsapp://send?text=Regarde l'état de la France http://www.website.com." data-action="share/whatsapp/share" title="whatsapp">
                    ...
                    <div>
                    <a href="" id="fb" class="" href="#" title="facebook">
                    ...
                    <div>
                    <a id="twitter" class="" href="#" title="twitter">
