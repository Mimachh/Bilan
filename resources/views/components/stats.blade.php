...
<section class="min-h-screen">
    <hr>
<h2 class="text-center my-10">Que souhaites-tu regarder ?</h2>

<div class="space-y-12 my-10 text-center text-white">
    <a href="" class="py-10 mx-12 md:mx-48 block lg:inline" style="background-image: url(storage/macron.jpg)">
    ECONOMIE
    </a>
    <a href="" class="py-10 mx-12 md:mx-48 block lg:inline" style="background-image: url(storage/macron.jpg)">
    IMMIGRATION
